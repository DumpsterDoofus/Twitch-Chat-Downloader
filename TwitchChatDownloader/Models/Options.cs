...
namespace TwitchChatDownloader.Models
{
    public class Options
    {
        ...
        [Option('u', "username", HelpText = "The username (for example, https://www.twitch.tv/zfg1 has username zfg1). Use this if you want to download subtitles for of a user's videos of a certain type.")]
